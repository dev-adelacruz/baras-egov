        ...
        <div className="p-3 border-t border-slate-700/50 shrink-0">
          <div className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-slate-800 transition-colors group">
            ...
            <button
              ...
              title="Sign out"
              className="p-1 text-slate-500 hover:text-danger-400 transition-colors opacity-0 group-hover:opacity-100"
            >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-6 shrink-0 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            {isBarangayScoped && (
              <span className="ml-1 inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-brand-50 border border-brand-200 text-brand-700 text-[11px] font-semibold">
                {barangay}
              </span>
            )}
          </div>
